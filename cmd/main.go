...
import (
	...
	"github.com/kazakovichna/todoListPrjct/pkg/handler"
...
func main () {
	...
	srv := new(todoListPrjct.Server)

	go func () {
		if err := srv.Run(viper.GetString("port"), handlers.InitRoutes()); err != nil {
			logrus.Fatalf("error occured while running http service: %s", err.Error())
		}
	}()

	logrus.Print("TodoApp StartUp")
